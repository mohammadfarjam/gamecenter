...
@section('content')
    ...
    <div class="container-fluid login p-0" style="height: 100vh">
        ...
        <div class="container">
            <div class="cont col-lg-9 col-md-12 col-sm-12">
                <div class="form">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <label>
                            ...
                            <input type="password" id="password-confirm" class="" name="password_confirmation" required autocomplete="new-password">

                        </label>

                        <button type="submit" class="submit mt-3">ثبت نام</button>
                ...
                <div class="img_side">
                    <img src="images/original/undraw_Add_friends_wa2a.png" alt="" class="mr-3">
                </div><!--img_side-->
